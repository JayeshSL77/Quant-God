...
class ScopeGuardrail:
    ...
    def __init__(self):
        ...
        self.blocked_keywords = [
            ...
            # Physics / Science (Off-Topic)
            "quantum physics", "quantum entanglement", "relativity", "black hole",
            "thermodynamics", "photosynthesis", "dna", "atom", "molecule",
            # Entertainment & Sports
            "recipe", "cooking", "football", "cricket score", "ipl",
            "movie review", "celebrity", "dating", "bollywood", "hollywood",
            # Weather & Travel
            "weather forecast", "weather today", "temperature", "travel", "tourism",
            # General Off-Topic
            "write a poem", "tell me a joke", "story", "song lyrics",
            "homework", "essay", "translate", "summarize this article"
        ]
    ...
    def check_query(self, user_query: str) -> dict:
        ...
        # =========== LAYER 5: No Financial Context = Block ===========
        # If we reach here with ZERO financial relevance, politely decline
        if financial_confidence == 0:
            # Check if query is clearly non-financial
            non_financial_indicators = [
                "explain", "what is", "how does", "tell me about", "describe",
                "who is", "when was", "where is", "why do"
            ]
            is_general_question = any(ind in query_lower for ind in non_financial_indicators)
            
            if is_general_question:
                return self._block_response(
                    reason="NO_FINANCIAL_CONTEXT",
                    message="I'm Inwezt, your Indian stock market assistant. I can help you with stock analysis, portfolio advice, market trends, and investment questions. How can I assist you with your financial queries today?"
                )
